<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
        ...
        <g fill="none">
            <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="M8.5 11v3M7 12.5h3" opacity=".5" />
            ...
            <path stroke="currentColor" stroke-linecap="round" stroke-width="1.5"
                d="M12 7V6a1 1 0 0 1 1-1h1a1 1 0 0 0 1-1V3" opacity=".5" />
...
<script>
export default {
    name: 'SolarGamepadMinimalisticLineDuotone'
}
</script>